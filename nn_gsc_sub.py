...
data_x= np.genfromtxt(r'C:\Users\aditya vikram\GSC_X_gsc_sub.csv', delimiter=',')
data_y= np.genfromtxt(r'C:\Users\aditya vikram\GSC_t_gsc_sub.csv',delimiter=',')
#Get the 512 fearture values
X = data_x[:, 0:512]
...
# 512 features as it is feature subtraction with gsc dataset
